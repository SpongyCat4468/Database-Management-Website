...
from discord_bot import run, isOnline  # your bot's run() function
...
@app.route("/")
def index():
    return render_template("index.html", commands=commands_text, bot_online=isOnline["value"])

@app.route("/bot_status")
def bot_status():
    return {"online": isOnline["value"]}
